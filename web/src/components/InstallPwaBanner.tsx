...
import { isPwaInstalled } from "../pwa.ts";
...
// membres réellement utilisés. L'évènement différé est déposé sur `window` par
// Sidebar ; on le relit via une vue typée locale, plutôt qu'une augmentation
// globale de Window qui vaudrait pour tout le projet.
